...
public class ProbeHashMap<K,V> extends AbstractHashMap<K,V> {
  ...
  public int getProbeHelper(K k , int hashValue) { //findslota probe int degiskenini ekledim ve her iterasyonun sonunda arttirip dondurdum.
    ...
    do {
      if (isAvailable(j)) {
        ...
        return probe;
      j = (j+1) % capacity;
      probe++; //probe sayisi kendi disinda gezdigi map yerleri oldugu icin (breake gelirse artmiyor) en sonda arttiriyorum
    } while (j != hashValue);
