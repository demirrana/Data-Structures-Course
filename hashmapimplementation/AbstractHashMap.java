...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  protected abstract int getProbeHelper(K key , int hashValue);

  public int getProbe(K key) {

    int hashValue = hashValue(key);

    return getProbeHelper(key , hashValue) + 1; //+1 kismi kendisi icin
  }

  //EKLEDIGIM KISMIN SONU
